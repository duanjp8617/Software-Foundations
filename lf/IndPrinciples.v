...
Proof.
  ...
  (* ...We now use the [induction] tactic to prove [P n] (that
     ...
     at the moment. *)
  Show Proof.
  induction n as [| n']. Show Proof.
  - (* n = O *)Show Proof.  reflexivity. Show Proof.
  - (* n = S n' *)
    ...
    simpl. Show Proof. rewrite -> IHn'. Show Proof.  reflexivity. Show Proof.  Qed.
